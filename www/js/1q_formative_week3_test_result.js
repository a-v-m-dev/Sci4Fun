function renderResults(correct){
  ...
  document.getElementById("getScore1QFormativeW3").value = correct_score;
...
var correct_score = document.getElementById("getScore1QFormativeW3");
localStorage.setItem("getScore1QFormativeW3", correct_score.value);
