function renderResults(correct){
  ...
  document.getElementById("getScore1QFormativeW2").value = correct_score;
...
var correct_score = document.getElementById("getScore1QFormativeW2");
localStorage.setItem("getScore1QFormativeW2", correct_score.value);
