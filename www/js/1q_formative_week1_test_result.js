function renderResults(correct){
  ...
  document.getElementById("getScore1QFormativeW1").value = correct_score;
...
var correct_score = document.getElementById("getScore1QFormativeW1");
localStorage.setItem("getScore1QFormativeW1", correct_score.value);
